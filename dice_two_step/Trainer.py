...
class Trainer:
    def __init__(self, training_data_path, model_path, validation_percentage,
        ...
        self.model = unet_first_step_model.Model(batch_norm_mode=self.batch_mode, depth=self.depth, img_size=img_size, n_channel=1, n_class=n_class, batch_size=self.batch_size)
