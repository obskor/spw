...
option_name = 'dice_2ch_180410-non_scaling_two_step_second'
...
class TrainerSecond:
    def __init__(self, training_data_path, model_path, validation_percentage,
        ...
        self.model = unet_second_step_model.Model(batch_norm_mode=self.batch_mode, depth=self.depth, img_size=img_size, n_channel=1, n_class=n_class, batch_size=self.batch_size)
