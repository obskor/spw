...
class Interlude:
    def __init__(self, data_path, model_path, batch_size=20, img_size=256):
        ...
        self.model = unet_first_step_model.Model(img_size=img_size, n_channel=1, n_class=2, batch_size=self.batch_size)
    ...
    def _predict(self, sess, x):
        ...
        predicted_result = sess.run(self.model.predicted, feed_dict=feed_dict)
